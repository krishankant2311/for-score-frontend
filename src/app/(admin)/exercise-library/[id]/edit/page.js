...
export default function EditExercisePage() {
  ...
  useEffect(() => {
    ...
    if (foundExercise && String(foundExercise.id) === String(exerciseId)) {
      ...
      setDifficulty(foundExercise.difficulty || "Beginner");
      setMediaType(foundExercise.mediaType || "Video");
      setStatus(foundExercise.status || "Active");
      setInstructions(foundExercise.instructions || "");
      setAlternateExercise(foundExercise.alternateExercise || "");
    } else {
      ...
      <div className="flex items-center gap-4 ">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#2158A3]">Update exercise details</p>
          </div>
        </div>
      </div>
