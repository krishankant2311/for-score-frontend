      ...
      >
        ...
        <div className="sticky top-0 z-10 bg-gradient-to-r from-[#0A3161] to-[#0D3D7A] px-6 py-4 rounded-t-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white">View User Details</h2>
              <p className="text-xs text-white/80 mt-0.5">User information overview</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-xl border border-[#C8D7E9] p-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="mt-1 text-sm font-medium text-[#0A3161] break-words">
                {user.email}
              </p>
            </div>
